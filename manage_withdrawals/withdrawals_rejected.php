...
// ดึงข้อมูลการเบิกเงินที่มีสถานะ 'Rejected'
$withdrawals = [];
$stmt = $conn->prepare("SELECT * FROM withdrawals WHERE status = 'Rejected' ORDER BY created_at DESC");
if ($stmt === false) {
...
<html lang="th">
<head>
    <title>รายการเบิกเงินไม่อนุมัติแล้ว</title>
    <meta charset="utf-8">
...
<body>
    <div class="container mt-4">
        ...
        <!-- ตารางแสดงรายการเบิกเงินไม่อนุมัติแล้ว -->
        <div class="card shadow-sm">
            <div class="card-header">
                <h5 class="mb-0"><i class="bi bi-x-circle me-2"></i>รายการเบิกเงินไม่อนุมัติแล้ว</h5>
            </div>
            <div class="card-body">
                    ...
                    <table class="table table-hover table-striped align-middle">
                        <thead class="table-danger">
                            <tr>
                                ...
                                <!-- หากต้องการเพิ่มการจัดการ สามารถเพิ่มคอลัมน์ที่นี่ได้ -->
                            </tr>
                        </thead>
                        <tbody>
                                ...
                                <?php foreach ($withdrawals as $row) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <span class="badge bg-danger">ไม่รับเรื่อง</span>
                                        </td>
                                        <!-- หากต้องการเพิ่มการจัดการ สามารถเพิ่มปุ่มจัดการที่นี่ได้ -->
                                    </tr>
                                <?php endforeach; ?>
                            <?php else : ?>
                                <tr>
                                    <td colspan="6" class="text-center">ไม่มีรายการเบิกเงินที่ไม่อนุมัติแล้ว</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
